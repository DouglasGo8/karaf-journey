...
public class ProducerActivator implements BundleActivator {
  ...
  RequestResponseApi requestResponseApi = new RequestResponseService();
  ServiceRegistration registration;

  public void start(BundleContext context) {

    this.registration = context.registerService(RequestResponseApi.class.getName(),
            requestResponseApi, null);
  }
